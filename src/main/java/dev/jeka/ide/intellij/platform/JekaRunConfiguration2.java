...
public class JekaRunConfiguration2
        extends
            ...
            //InputRedirectAware
{
    ...
    public JekaRunConfiguration2(String name, @NotNull Project project, @NotNull JekaRunConfigurationType configurationType) {
        this(name, project, configurationType.getConfigurationFactories()[0]);
    }

    public JekaRunConfiguration2(final String name, @NotNull Project project) {
        this(name, project, JekaRunConfigurationType.INSTANCE.getConfigurationFactories()[0]);
    }

    protected JekaRunConfiguration2(String name, @NotNull Project project, @NotNull ConfigurationFactory factory) {
    ...
    public SettingsEditor<? extends RunConfiguration> getConfigurationEditor() {
        SettingsEditorGroup<JekaRunConfiguration2> group = new SettingsEditorGroup<>();
    ...
    public static class JavaApplicationCommandLineState<T extends JekaRunConfiguration2> extends ApplicationCommandLineState<T> {
